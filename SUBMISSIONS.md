...
| Ai2 | ACE2.2-ERA5 | [^4] | https://github.com/ai2cm/ace | 'aimip', 'aimip-p2k', 'aimip-p4k' | daily, monthly | 1°x1° | 7 pressure levels ('gr'), regridded from native 8 model layers via ML that are also submitted ('gn') | ACE2.2-ERA5 is a substantially revised recipe relative to ACE2.1-ERA5: 1) revised normalization and module hyperparameters (v2 ERA5-only recipe, non-residual prediction, global-mean removal), 2) no CO<sub>2</sub> input, and 3) a stochastic model, so the five realizations share one initial condition and differ only by random seed. Both models use a 6-hourly timestep. The evaluated checkpoint was updated in 2026-09 to training seed 3, selected as best of four on 36-year in-sample rollouts. Evaluated locally; not yet uploaded to the AIMIP archive. | `v20260908` | `local_data/Ai2/ACE2-2-ERA5/aimip/r1i1p1f1/Amon/ta/gr/v20260908/ta_Amon_ACE2-2-ERA5_aimip_r1i1p1f1_gr_197810-202412.nc` |
| University of Washington DLESyM/Durran group; NVIDIA | DLESyM | [^8] | https://github.com/AtmosSci-DLESM/DLESyM | 'aimip', 'aimip-p2k', 'aimip-p4k' | daily, monthly | 1°x1° | subset of pressure levels | Trained on 1983-2016 (i.e., included some AIMIP holdout data in training); only a small subset of variables available. | `v20260406` | `s3://ai-mip/DLESyM/DLESyM/aimip/r1i1p1f1/Amon/ta/gn/v20260406/ta_Amon_DLESyM_aimip_r1i1p1f1_gn_19781016-20241216.nc` |
